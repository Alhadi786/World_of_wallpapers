...
public class DatabaseHandlerDownload extends SQLiteOpenHelper {

    private static final int DATABASE_VERSION = 2;

    private static final String DATABASE_NAME = "db_mw_download";
    ...
    public DatabaseHandlerDownload(Context context) {
    ...
    public void Addtodownload(ItemRecent pj) {
    ...
    // Getting All Data
    public List<ItemRecent> getAllDownloadData() {
    ...
    public enum DatabaseManager {
        ...
        DatabaseHandlerDownload dbHelper;

        public void init(Context context) {
            dbHelper = new DatabaseHandlerDownload ( context);
            if (isDbClosed) {
                isDbClosed = false;
